    ...
    EmailTemplate {
        ...
        html_content: format!(
            ...
            <body style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                <h1 style="color: #00B488;">Verify your {} email</h1>
                ...
                <p style="color: #666; font-size: 14px; margin-top: 30px;">
                    If you didn't sign up for {}, you can safely ignore this email.
                </p>
            </body>
            </html>
            "#,
            BRAND_NAME, verification_url, verification_url, verification_url, BRAND_NAME
        ),
        text_content: format!(
            "Thanks for signing up! Please verify your email address by clicking this link:\n\n{}\n\nIf you didn't sign up for {}, you can safely ignore this email.",
            verification_url, BRAND_NAME
        ),
    }
}
...
fn build_password_reset_email_template(reset_url: &str) -> EmailTemplate {
    EmailTemplate {
        ...
        html_content: format!(
            ...
            <html>
            <body style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                <h1 style="color: #00B488;">Reset your {} password</h1>
            ...
            "#,
            BRAND_NAME, reset_url, reset_url, reset_url
        ),
        text_content: format!(
    ...
    EmailTemplate {
        ...
        html_content: format!(
            ...
            <body style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <p>Your Vine account has been migrated to {}. Click the button below to claim it and set up your login:</p>
                <div style="margin: 30px 0;">
                    <a href="{}"
                       style="background: #00B488; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block; font-weight: bold;">
                        Claim Your Account
            ...
            "#,
            BRAND_NAME, claim_url, claim_url, claim_url
        ),
        text_content: format!(
            "Your Vine account has been migrated to {}. Click this link to claim it:\n\n{}\n\nThis link will expire in 14 days. If you didn't request this, you can safely ignore this email.",
            BRAND_NAME, claim_url
        ),
    }
}
...
mod tests {
    ...
    fn verification_template_includes_url_and_subject() {
        ...
        assert_eq!(
            template.subject,
            format!("Verify your {} email address", BRAND_NAME)
        );
    ...
    fn reset_template_includes_url_and_subject() {
        ...
        assert_eq!(
            template.subject,
            format!("Reset your {} password", BRAND_NAME)
        );
        assert!(template.html_content.contains(url));
        assert!(template.text_content.contains(url));
    }
    ...
    fn claim_template_includes_url_and_subject() {
        ...
        assert_eq!(
            template.subject,
            format!("Your Vine account on {} is ready to claim", BRAND_NAME)
        );
        assert!(template.html_content.contains(url));
        assert!(template.text_content.contains(url));
    }
